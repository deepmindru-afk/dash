...
CASES: list[dict] = [
    # Analyst cases — data questions route to Analyst's SQLTools
    ...
    # Engineer cases — schema modifications route to Engineer's SQLTools
    {"input": "Create a view for monthly MRR by plan", "expected_tools": ["run_sql_query", "update_knowledge"]},
]
